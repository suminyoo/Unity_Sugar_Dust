...
public class PlayerAssetsManager : MonoBehaviour, ISaveable
{
    ...
    [Header("Sounds")]
    public SoundData moneySpendSound;
    public SoundData moneyEarnSound;
    ...
    public bool TrySpendMoney(int amount)
    {
        ...
        {
            if(moneySpendSound.clip != null) SoundManager.Instance.PlaySFX2D(moneySpendSound);
            currentMoney -= amount;
            OnMoneyChanged?.Invoke(currentMoney);
            return true;
        }
    ...
    public bool CheckMoney(int amount)
    {
        ...
        {
            NotificationUIManager.Instance.ShowNotification("µ·ÀÌ ºÎÁ·ÇÕ´Ï´Ù.");
            return false;
